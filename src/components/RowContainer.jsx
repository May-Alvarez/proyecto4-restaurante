        ...
        >
            {data && data.length > 0 ? (
                data.map((item) => (
                    <div 
                    key={item?.id}
                    className="w-275 h-[175px] min-w-[275px] md:w-300 md:min-w-[300] bg-cardOverlay
                ...
                <div className="w-full flex flex-col items-center justify-center">
                    ...
                    alt="NotFound"
                    className="h-340" />
                    <p className="text-lg text-headingColor font-semibold my-2"> Elementos no encontrados</p>
                </div>
            )}
        </div>
    );
