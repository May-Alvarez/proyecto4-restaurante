...
const CreateContainer = () => {
    ...
    const uploadImage = (e) => {
        ...
        uploadTask.on("state_changed", (snapshot)=> {
            ...
            console.log(error);
            setFields(true);
            setMsg("Error al actualizar : Intente nuevamente");
    ...
    const deleteImage = () => {
        ...
        deleteObject(deleteRef).then(() => {
            ...
            setIsLoading(false);
            setFields(true);
            setMsg("Imagen borrada correctamente");
            setTimeout(() => {
                setFields(false);
            }, 4000);
        });
    ...
    const saveDetails = () => {
        ...
        try {
            if(!title || !calories || !imageAsset || !price || !category){
                setFields(true);
                setMsg("Los campos obligatorios no pueden estar vacíos");
                setAlertStatus("danger");
                setTimeout(() => {
                    setFields(false);
                    setIsLoading(false);
                            ...
                            <>
                                ...
                                cursor-pointer">
                                    <div className="w-full h-full flex flex-col items-center justify-center gap-2">
                                        ...
                                        <p className="text-gray-500 hover:text-gray-700"> Haz clic para actulizar</p>
                                    </div>
                                    <input
                                    type="file"
                                    name="uploadimage"
