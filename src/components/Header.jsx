        ...
        <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
            ...
            <div className="hidden md:flex w-full h-full items-center justify-between">
                <Link to={"/"} className= "flex items-center gap-2">
                    ...
                    <p className="text-headingColor text-xl front-bold">Brujo</p>
                </Link>
                ...
                <div className="flex items-center gap-8">
                    ...
                    className="flex items-center gap-8">
                        ...
                        <li className="text-base text-textColor hover:text-headingColor duration-100
                        transition-all ease-in-out cursor-pointer"> Sobre nosotros</li>
                        <li className="text-base text-textColor hover:text-headingColor duration-100
                        transition-all ease-in-out cursor-pointer"> Servicios</li>
                    </motion.ul>
                    ...
                    {isMenu &&(
                        ...
                        className="w-40 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0">
                            ...
                            <ul className="flex flex-col">
                                ...
                                <li className="text-base text-textColor hover:text-headingColor duration-100
                                transition-all ease-in-out cursor-pointer hover: bg-slate-100 px-4 py-2">Sobre nosotros</li>
                                <li className="text-base text-textColor hover:text-headingColor duration-100
                                transition-all ease-in-out cursor-pointer hover: bg-slate-100 px-4 py-2">Servicios</li>
                            </ul>
                            <p className="m-2 p-2 flex items-center rounded-md shadow-md justify-center bg-gray-200
